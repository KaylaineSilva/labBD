...
\copy stg_circuits              FROM 'C:/Users/kayla/Documents/dados_labBD/circuits.csv'                 WITH (FORMAT csv, HEADER true, ENCODING 'LATIN1');
\copy stg_constructors          FROM 'C:/Users/kayla/Documents/dados_labBD/constructors.csv'             WITH (FORMAT csv, HEADER true);
\copy stg_drivers               FROM 'C:/Users/kayla/Documents/dados_labBD/drivers.csv'                  WITH (FORMAT csv, HEADER true);
\copy stg_races                 FROM 'C:/Users/kayla/Documents/dados_labBD/races.csv'                    WITH (FORMAT csv, HEADER true);
\copy stg_driver_standings      (season, round, driver_id, position, points, wins)      FROM 'C:/Users/kayla/Documents/dados_labBD/driver_standings.csv'      WITH (FORMAT csv, HEADER true);
\copy stg_constructor_standings (season, round, constructor_id, position, points, wins) FROM 'C:/Users/kayla/Documents/dados_labBD/constructor_standings.csv' WITH (FORMAT csv, HEADER true);
\copy stg_results               FROM 'C:/Users/kayla/Documents/dados_labBD/results.csv'                  WITH (FORMAT csv, HEADER true);
\copy stg_qualifying            FROM 'C:/Users/kayla/Documents/dados_labBD/qualifying.csv'               WITH (FORMAT csv, HEADER true);

-- Carregar dados geográficos complementares para staging
\copy stg_airports              FROM 'C:/Users/kayla/Documents/dados_labBD/airports.csv'                 WITH (FORMAT csv, HEADER true);
\copy stg_countries             FROM 'C:/Users/kayla/Documents/dados_labBD/countries.csv'                WITH (FORMAT csv, HEADER true);
\copy stg_time_zones            FROM 'C:/Users/kayla/Documents/dados_labBD/timeZones.tsv'                WITH (FORMAT csv, HEADER true, DELIMITER E'\t');
\copy stg_feature_codes         FROM 'C:/Users/kayla/Documents/dados_labBD/featureCodes_en.tsv'          WITH (FORMAT csv, HEADER false, DELIMITER E'\t');
\copy stg_iso_language_codes    FROM 'C:/Users/kayla/Documents/dados_labBD/iso-languagecodes.tsv'        WITH (FORMAT csv, HEADER true, DELIMITER E'\t');
\copy stg_cities                FROM 'C:/Users/kayla/Documents/dados_labBD/cities.tsv'                   WITH (FORMAT csv, HEADER false, DELIMITER E'\t');
-- ============================================================================================================
